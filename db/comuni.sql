...
INSERT INTO `comuni` (`id`, `id_regione`, `id_provincia`, `nome`, `capoluogo_provincia`, `codice_catastale`, `latitudine`, `longitudine`) VALUES
...
--
ALTER TABLE `comuni`
  ADD CONSTRAINT `comuni_ibfk_1` FOREIGN KEY (`id_regione`) REFERENCES `regioni` (`id`),
  ADD CONSTRAINT `comuni_ibfk_2` FOREIGN KEY (`id_provincia`) REFERENCES `province` (`id`);
COMMIT;
